...
export const buildCallsMenu = (keyboard: any, serviceChat: any) => {
    ...
    if (override) {
        lines.push(
            `\u041F\u0435\u0440\u0435\u043E\u043F\u0440\u0435\u0434\u0435\u043B\u0435\u043D\u0438\u0435 \u0438\u0441\u0442\u043E\u0447\u043D\u0438\u043A\u0430: ${sourceLabel(override)}`
        );
    } else {
        lines.push(
            `\u0418\u0441\u0442\u043E\u0447\u043D\u0438\u043A: \u0430\u0432\u0442\u043E (\u0441\u0435\u0439\u0447\u0430\u0441: ${sourceLabel(activeSource)})`
        );
    }
    ...
    if (activeSource === 'site' && raspCache.calls.site.updatedAtRaw) {
        lines.push(
            `\u041E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u043E \u043D\u0430 \u0441\u0430\u0439\u0442\u0435: ${raspCache.calls.site.updatedAtRaw}`
        );
        ...
        lines.push(
            '\u0418\u0441\u043F\u043E\u043B\u044C\u0437\u0443\u044E\u0442\u0441\u044F \u0434\u0430\u043D\u043D\u044B\u0435 \u0438\u0437 \u043A\u043E\u043D\u0444\u0438\u0433\u0430'
        );
    }

    const finalKeyboard = builder
        .add({
            text: '\u041C\u0435\u043D\u044E \u043D\u0430\u0441\u0442\u0440\u043E\u0435\u043A',
