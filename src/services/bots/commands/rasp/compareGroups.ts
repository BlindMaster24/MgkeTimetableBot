...
export default class CompareGroupsCommand extends AbstractCommand {
    public regexp = /^(((!|\/)(comparegroups|comparegroup|groupscompare))|(\u0421\u0440\u0430\u0432\u043d\u0438\u0442\u044c \u0433\u0440\u0443\u043f\u043f\u044b))(\b|$|\s)/i;
    public payloadAction = null;
    public scene?: string | null = null;
    public tgCommand: TelegramBotCommand[] = [
        {
            command: 'comparegroups',
            description: '\u0421\u0440\u0430\u0432\u043d\u0438\u0442\u044c \u0440\u0430\u0441\u043f\u0438\u0441\u0430\u043d\u0438\u044f \u0434\u0432\u0443\u0445 \u0433\u0440\u0443\u043f\u043f'
        }
    ];
    ...
    async handler(params: CmdHandlerParams<CompareGroupsCommand>) {
        ...
        let groupA: string | false | undefined = await context.input(`\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u043d\u043e\u043c\u0435\u0440 \u043f\u0435\u0440\u0432\u043e\u0439 \u0433\u0440\u0443\u043f\u043f\u044b (\u043d\u0430\u043f\u0440\u0438\u043c\u0435\u0440, ${firstExample})`, {
        ...
        let groupB: string | false | undefined = await context.input(`\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u043d\u043e\u043c\u0435\u0440 \u0432\u0442\u043e\u0440\u043e\u0439 \u0433\u0440\u0443\u043f\u043f\u044b (\u043d\u0430\u043f\u0440\u0438\u043c\u0435\u0440, ${secondExample})`, {
            keyboard: withCancelButton(keyboard.GroupHistory)
        }).then<string | undefined>(value => {
            initiator = value?.initiator;
            return value?.text;
        ...
        while (true) {
            ...
            if (groupA === groupB) {
                await context.send('\u0412\u044b\u0431\u0435\u0440\u0438\u0442\u0435 \u0434\u0432\u0435 \u0440\u0430\u0437\u043d\u044b\u0435 \u0433\u0440\u0443\u043f\u043f\u044b', {
        ...
        for (let dayIndex = weekRange[0]; dayIndex <= weekRange[1]; dayIndex += 1) {
            ...
            for (let i = 0; i < maxPairs; i += 1) {
                ...
                if (a && b) {
                    ...
                    overlapDetails.push(`${i + 1}) ${aText} | ${bText}${same.length ? " \u2014 \u0441\u043e\u0432\u043f\u0430\u0434\u0430\u0435\u0442" : ""}`);
                }
            ...
            lines.push(`\u0421\u043e\u0432\u043f\u0430\u0434\u0430\u044e\u0449\u0438\u0435 \u043f\u0430\u0440\u044b: ${overlap.length ? overlap.join(", ") : "\u043d\u0435\u0442"}`);
            if (overlapDetails.length) {
                lines.push(`\u041f\u0430\u0440\u044b:`);
                lines.push(overlapDetails.join("\n"));
            }
            lines.push(`\u041e\u0431\u0449\u0438\u0435 \u043f\u0440\u0435\u0434\u043c\u0435\u0442\u044b: ${sameSubjects.length ? sameSubjects.join(", ") : "\u043d\u0435\u0442"}`);
            lines.push(`\u041e\u0431\u0449\u0438\u0435 \u043e\u043a\u043d\u0430: ${free.length ? free.map((pair) => this.formatPair(pair, calls[pair - 1])).join(", ") : "\u043d\u0435\u0442"}`);
        }
