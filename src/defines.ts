...
export const defines = {
    ...
    'vk.message.about':
        'Бот был создан [id290331922|Алексеем Костюком] из группы 63ТП. Для сообщения о багах или запроса функционала писать ему.\n\n' +
        `${globalLinks}\n\n` +
        'Отключить/включить кнопку "О боте" можно в настройках.',

    'viber.message.about':
        'Бот был создан Алексеем Костюком из группы 63ТП. Для сообщения о багах или запроса функционала писать ему в вк: https://vk.com/keller18306.\n\n' +
        `${globalLinks}\n\n` +
        'Отключить/включить кнопку "О боте" можно в настройках.',

    'tg.message.about':
        'Бот был создан Алексеем Костюком из группы 63ТП. Для сообщения о багах или запроса функционала писать ему в тг: @keller18306.\n\n' +
        `${globalLinks}\n\n` +
        'Отключить/включить кнопку "О боте" можно в настройках.',

    'need.accept':
        'У вас нет доступа, чтобы использовать бота.\n\n' +
...
export const hints: string[] = [
    ...
    // 'Переименуй любой предмет, как захочешь! (/alias)'
];
