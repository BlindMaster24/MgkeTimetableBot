...
func TestBotRegisterCommands(t *testing.T) {
	b := setupTestBot(t)
	expected := []string{"/start", "/help", "/cancel", "/setup", "/day", "/week", "/calls", "/about", "/group", "/teacher", "/settings", "/image", "/buttons", "/formatter", "/forceparse", "/resetcache", "/eula", "/api", "/diff", "/notice", "/view", "/dev", "/math", "/flushcache", "/acceptbot", "/debug", "/send", "/trigger", "/history", "/stats", "/google_calendar", "/alias", "/regexp", "/vanish", "/parserLogs", "/requireNewButtons", "/createApiKey", "/cabinet", "/groups", "/teachers", "/comparegroups", "/ping", "/ics", "/subscriptions", "/subscriptions_test", "/archive", "/endings", "/chat", "/id", "/error", "/test", "/indexToStrDate", "/strToIndex", "/groupweek", "/groupimage", "/teacherweek", "/teacherimage", "/setgroup", "/setteacher", "/vychetkaDlyaBrovkiDSOnline", "/sql", "/restart", "/archivestats", "/noticedebug", "/buttons_reload", "/parserhealth", "/incidents", "/webhook"}
