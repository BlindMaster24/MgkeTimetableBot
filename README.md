...
| Файл | Что проверяет |
|------|---------------|
| `internal/parser/*_test.go` | разбор групп, преподавателей и звонков, заголовки любой формы, `colspan`, одиночные колонки, текстовый фолбэк, прокси, планировщик опроса, защита кэша от пустого ответа |
